...
public interface RefreshApi {
    ...
    default ResponseEntity<AuthPost200Response> refreshPost(
        @Parameter(name = "RefreshPostRequest", description = "", required = true) @Valid @RequestBody RefreshPostRequest refreshPostRequest
    ) {
